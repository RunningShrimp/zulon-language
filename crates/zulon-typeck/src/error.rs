...
pub enum TypeError {
    ...
    UndefinedEffect { name: String, span: Span },
    ...
    RecursiveType { ty: Ty, span: Span },

    #[error("integer literal too large")]
    IntegerOverflow { span: Span },

    #[error("cannot convert {from} to {to}")]
    CannotConvert { from: Ty, to: Ty, span: Span },
}
